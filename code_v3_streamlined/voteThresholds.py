...
MAX_LINK_VOTES = 175 
f1 = open(DATAPATH+"/links-politics.txt","r")
f2 = open(DATAPATH+"/votes-summary.txt","r")
t1 = open(DATAPATH+"/threshold_max"+str(MAX_LINK_VOTES)+"-links-politics.txt","w")
#t2 = open(PATH+"/data/threshold_min"+str(MIN_USER_VOTES)+"_max"+str(MAX_USER_VOTES)+"-users.txt","w")
t2 = open(DATAPATH+"/threshold_max"+str(MAX_USER_VOTES)+"-users.txt","w")
