# This program creates lists of top users in each community. Meaning that it only keeps those users with a value (here pagerank value) higher than a certain threshold
